...
public class EnableFingerprintActivity extends OnboardingActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            presenter.setOnboardingState(OnboardingPresenter.OnboardingState.TEST_ENABLE_FINGERPRINT);
        }
    }
}
